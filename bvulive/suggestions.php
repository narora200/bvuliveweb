...
<title>Bharati Vidyapeeth University | Suggest Us</title>
</head>
<body>
...
$suggest= @$_POST['suggest'];
	...
	$suggestion = mysql_real_escape_string(strip_tags(@$_POST['suggestion']));
		...
		$query = mysql_query("INSERT INTO suggestions VALUES ('' , '$email' , '$suggestion')");
		if($query){
...
<div class="container" style="padding:0px 0px;padding-bottom:50px;">
	<div class=" col-sm-12 text-center" style="padding:0px 0px;">
	<img src="./img/suggest.jpg" style="width:100%;overflow-y:hidden;height:500px;" class="img-responsive">
	</div>
	<div class="col-sm-12 text-center">
	<br>
	 <h1 style="font-size:3.0em;font-weight:900;">Suggest Us</h1>
	 <h2 style="font-size:2.0em;font-weight:700;">Your Suggestions Are More Than Welcome!</h2>
	 <h3 style="font-size:1.5em;font-weight:500;">By just spending a few minutes of your time, you can help us provide a better user-experience, thus making our college and your events more popular!</h3>
	 <div>
	 &nbsp;
	 </div>
	 <div>
	 ...
	 <div class="col-sm-12">
	 <form role="form" action="suggestions.php" method="POST" class="form-horizontal">
