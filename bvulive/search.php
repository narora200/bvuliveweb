...
<title>Bharati Vidyapeeth University | Search Event</title>
</head>
<body>
...
<?php
	...
	$s_submit = @$_POST['s_submit'];
	

	$s_query = '';

	$e_name_search = mysql_real_escape_string(strip_tags($_POST['ne_name']));
	
	$e_name_lower_search = strtolower($e_name_search);

	$e_name_firstword_search = ucwords($e_name_lower_search);

	$query = mysql_query("SELECT p_id FROM events WHERE e_name = '$e_name_firstword_search' AND e_posted = '1'");
	...
	if($check == 0){
		...
		echo '<div class="alert alert-info">
  		...
  		<span style="font-size:1.5em;font-weight:700;">Sorry, No event has been found with this name - '.$e_name_firstword_search.'</span>
		<span style="float: right;"><a href="index.php" >Go back</a></span>
		</div>';
		...
		$row = mysql_fetch_assoc($query);
				$sid['p_id'] = $row['p_id'];
				echo '<script> location.replace("einfo/'.$sid['p_id'].'"); </script>';
